...
$terdugaTB = new \Mediator\SatuSehat\Lib\Client\Profiles\TB\Forms\Terduga();
$terdugaTB->setProfile(["TB"]);
$terdugaTB->setOrganizationId("100011961");
$terdugaTB->setLocationId("ef011065-38c9-46f8-9c35-d1fe68966a3e");
$terdugaTB->setPractitionerNik("N10000001");
$terdugaTB->setPatient([
...
/*$terdugaTB->setData(new SubmitRequest([
    "profile" => ["TB"],
