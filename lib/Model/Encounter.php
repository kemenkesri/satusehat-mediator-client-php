...
class Encounter extends MediatorResourceBasic 
{
    ...
    const CLASSIFICATION_AMB = 'AMB';
    const CLASSIFICATION_EMER = 'EMER';
    const CLASSIFICATION_IMP = 'IMP';
    const STATUS_AKHIR_PULANG_PAKSA = 'pulang_paksa';
    const STATUS_AKHIR_DIRUJUK = 'dirujuk';
    const STATUS_AKHIR_MENINGGAL = 'meninggal';
    const STATUS_AKHIR_SEMBUH = 'sembuh';
