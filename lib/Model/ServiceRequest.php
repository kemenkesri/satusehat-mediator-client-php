...
class ServiceRequest extends MediatorResourceBasic 
{
    ...
    const REFERRAL_STATUS__3457005 = '3457005';
    const REFERRAL_STATUS__306098008 = '306098008';
    const REQUESTER_TYPE_ORGANIZATION = 'Organization';
    const REQUESTER_TYPE_PRACTITIONER = 'Practitioner';
