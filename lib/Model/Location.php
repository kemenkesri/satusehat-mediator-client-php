...
class Location extends MediatorResourceBasic 
{
    ...
    const TYPE_LOCATION_TEMPAT_MENINGGAL_NONFASKES = 'tempat_meninggal_nonfaskes';
    const TYPE_LOCATION_TEMPAT_MENINGGAL_FASKES = 'tempat_meninggal_faskes';
    const TYPE_LOCATION_ALAMAT_LAHIR = 'alamat_lahir';
    const TYPE_LOCATION_ALAMAT_MATI = 'alamat_mati';
    const TYPE_LOCATION_ALAMAT_BERSALIN = 'alamat_bersalin';
